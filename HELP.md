...
* The original package name 'pl.barteksmalec.oauth2-resource-server-demo' is invalid and this project uses 'pl.barteksmalec.oauth2resourceserverdemo' instead.
